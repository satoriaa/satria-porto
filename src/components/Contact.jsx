  ...
  <div className="grid grid-cols-2 gap-4">
    {[
      ...
      >
        ...
        {/* Icon Container dengan Efek Pop-up */}
        ...
        {/* Label dengan Tracking Animation */}
        ...
        {/* Garis Dekoratif Tipis di Bawah */}
          ...
          <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-6 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-opacity-5 relative">
             ...
             <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2 group/input">
                   ...
                   <input required type="text" placeholder="Your Name" className="w-full bg-[#f8f8f8] border-4 border-black p-3 font-bold text-sm focus:bg-white focus:outline-none focus:shadow-[8px_8px_0px_0px_rgba(250,204,21,1)] transition-all shadow-[inset_4px_4px_0px_rgba(0,0,0,0.05)]" />
                </div>
                <div className="space-y-2 group/input">
                   ...
                   <input required type="email" placeholder="email@example.com" className="w-full bg-[#f8f8f8] border-4 border-black p-3 font-bold text-sm focus:bg-white focus:outline-none focus:shadow-[8px_8px_0px_0px_rgba(250,204,21,1)] transition-all shadow-[inset_4px_4px_0px_rgba(0,0,0,0.05)]" />
                </div>
             </div>
             ...
             <div className="space-y-2 group/input">
                ...
                <textarea required rows="4" placeholder="Transmission details..." className="w-full bg-[#f8f8f8] border-4 border-black p-3 font-bold text-sm focus:bg-white focus:outline-none focus:shadow-[8px_8px_0px_0px_rgba(250,204,21,1)] transition-all resize-none shadow-[inset_4px_4px_0px_rgba(0,0,0,0.05)]"></textarea>
             </div>
