...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#dfdfdf] border-t-8 border-black mt-auto relative z-50">
      
      {/* --- SECTION 1: THE CYBER TICKER (MARQUEE) --- */}
